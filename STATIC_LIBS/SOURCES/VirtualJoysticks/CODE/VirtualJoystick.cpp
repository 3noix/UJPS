...
VirtualJoystick::VirtualJoystick(uint id, uint nbButtons, bool bForcedInit) : QObject()
{
	...
	if (status == VJD_STAT_OWN)
		...
		throw ExceptionFailedToAcquireVJoyDevice("vJoy device " + QString::number(m_id).toStdString() + " unknown error");
...
// SET VJOY CONFIG EXE PATH ///////////////////////////////////////////////////
void VirtualJoystick::setVJoyConfigExePath(QString exeFilePath)
{
