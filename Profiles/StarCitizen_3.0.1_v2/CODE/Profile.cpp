...
void Profile::set_THR_and_pedals()
{
	...
	Map(mfgx, ControlType::Axis, MFGX::BRK_LEFT, AllLayers, new TriggerAxisChangeComparison{true,-0.95f}, new ActionButtonPress{vj1,SC::Brake});
	Map(mfgx, ControlType::Axis, MFGX::BRK_LEFT, AllLayers, new TriggerAxisChangeComparison{false,-0.95f}, new ActionButtonRelease{vj1,SC::Brake});
	if (mfgx->axisValue(MFGX::BRK_LEFT) > -0.95f)
...
void Profile::set_BRKRIGHT_for_groundForward()
{
	...
	mfgx->setCustomCurve(MFGX::BRK_RIGHT, {-1.0f,0.0f,  1.0f,1.0f});
