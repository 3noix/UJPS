...
LogitechX56Joystick::LogitechX56Joystick(QGameController *c) : RealJoystick{c}
{
	...
	m_axesNames << "JOYY" << "JOYX" << "RUDDER" << "JOYROTY" << "JOYROTX";
...
void LogitechX56Joystick::slotGameControllerAxisEvent(QGameControllerAxisEvent *event)
{
	...
	if (axis == 0)      {m_changes << JoystickChange{this, ControlType::Axis, LogitechX56Joystick_::JOYY,   false, event->value()};}
	else if (axis == 1) {m_changes << JoystickChange{this, ControlType::Axis, LogitechX56Joystick_::JOYX,   false, event->value()};}
...
{
	if      (axis == LogitechX56Joystick_::JOYY)    { return this->RealJoystick::axisValue(0); }
	else if (axis == LogitechX56Joystick_::JOYX)    { return this->RealJoystick::axisValue(1); }
