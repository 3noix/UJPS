...
// CONSTRUCTEUR ET DESTRUCTEUR ////////////////////////////////////////////////
MainWindow::MainWindow(QWidget *parent) : QWidget{parent}, m_joyManager{}
{
...
AbstractAxisCurve* MainWindow::createCurve(const QString &curveName) const
{
	...
	else if (curveName == "J curve") {return new JCurve{};}
	else if (curveName == "S curve") {return new SCurve{};}
	else                             {return nullptr;}
}
...
void MainWindow::slotRunOneLoop()
{
	...
	{
		if (ch.type == ControlType::Axis && ch.numButtonOrAxis == m_axis)
