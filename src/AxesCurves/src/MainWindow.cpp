...
#include "RealJoysticks/RealJoysticksManager.h"
#include "QtGameControllerModif/GameControllersEnumThread.h"
...
#include "VigemWrapper/VigemSettingsWidget.h"
...
void MainWindow::setupWidget()
{
	...
	this->setWindowIcon(QIcon{":/icons/curve.png"});
}
